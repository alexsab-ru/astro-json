...
export MODEL_XPATH="substring-before(substring-after(.//div[contains(@class, 'web_block_models__item-btn')]/a/@href, '/models/'), '/')"
...
export OUTPUT_PATHS="./src/haval-ulyanovsk.ru/data/cars.json"
