...
export ID_XPATH="concat('tank-', substring-after(.//*[contains(concat(' ', normalize-space(@class), ' '), ' car-info-title ')]/text(), 'TANK '))"
export MODEL_XPATH="concat('TANK ', substring-after(.//*[contains(concat(' ', normalize-space(@class), ' '), ' car-info-title ')]/text(), 'TANK '))"
...
export OUTPUT_PATHS="./src/tank.alexsab.ru/data/cars.json"
