...
export ITEM_XPATH="//div[contains(concat(' ', normalize-space(@class), ' '), ' menu__models-item ')]"
...
export LINK_XPATH=".//a[contains(@class, 'js-menu-models-link menu__models-item-link')]/@href"
