export BRAND='jetour'
export URL="https://jetour-ru.com/models"
...
export MODEL_CSS="div[class='td-card-widget__text']>span[class*='td-card-widget__title']"
export PRICE_CSS="div[class*='td-card-widget__description']>span>span"
