...
export PRICE_XPATH="translate(string(.//div[contains(@class, 'td-model-card__price')]/text()[1]), translate(string(.//div[contains(@class, 'td-model-card__price')]/text()[1]), '0123456789', ''), '')"
