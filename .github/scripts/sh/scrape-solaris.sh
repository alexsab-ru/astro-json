...
export OUTPUT_PATHS="./src/solaris.alexsab.ru/data/cars.json"
export CLICK_SELECTOR="body > main > header > div > div.landing-section[class^='header_content__'] > nav > button:nth-child(1)"
export WAIT_SELECTOR="body > main > header > div > div.landing-section[class^='header_content__'] > nav > button:nth-child(1)"
export WAIT_TIME=1
